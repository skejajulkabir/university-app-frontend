    ...
    <Link to={"/createpost"}>
        ...
        <div className="flex flex-col  rounded-lg bg-slate-200 shadow-2xl  lg:mt-20  md:max-w-3xl mx-auto mb-2 mt-2">
            ...
            <div className="bg-slate-300 p-4 flex flex-row rounded-lg h-full justify-center items-center mx-2 ">  
                ...
                <input className="placeholder:italic placeholder:text-slate-600 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm cursor-pointer " autoComplete='off' placeholder="Create a post!" type="text" name="search"/>
