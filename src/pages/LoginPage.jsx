    ...
    <div className='h-screen '>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="/forgotpassword" className="font-semibold text-pink-600 hover:text-pink-500">Forgot password?</Link>
              </div>
            </div>
            <div className="mt-2">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <Link to="/signuppage" className="font-semibold leading-6 text-pink-600 hover:text-pink-500"> Create new account.</Link>
        </p>
      </div>
    </div>
    </div>
