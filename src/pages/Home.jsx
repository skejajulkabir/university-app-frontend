        ...
        <div className="pt-24">
          <div className="min-h-screen flex flex-col items-center justify-center px-6">
            <div className="text-3xl font-serif bg-slate-300 p-6 py-10 rounded-md">
              To access the home page of the site you have to login and varify
              yourself first as a{" "}
              <span className="text-4xl text-red-500 px-4 bg-slate-200 rounded-md">
                JUSTIAN
              </span>
              ...
            </div>
            ...
            {!localStorage.getItem("TOKEN") && (
              <Link to={"/signuppage"}>
                <div className="text-3xl font-serif bg-blue-300 mt-10 p-6 py-6 rounded-md">
                  Create new account...
                </div>
              </Link>
            )}
